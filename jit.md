...
1. Support break and continue in for and do-while statements
2. Support more data forms such as dictionary and more data types such as STRING. 
3. Support more mathematical and statistical functions.
4. Enhance type inference. Can infer the data types of results for more built-in functions.
5. Support declaration of data types for parameters, results and local variables in user-defined functions.
