...
- [Backup and Restore (Before version 2.00.8)](backup_and_restore_before.md)
...
- [Offline Installation Guide for DolphinDB Python API](python_api_install_offline.md)
...
- [Introduction to DolphinDB Plugin](https://github.com/dolphindb/DolphinDBPlugin/blob/master/README.md)
...
- [ZeroMQ](https://github.com/dolphindb/DolphinDBPlugin/blob/release200/zmq/README_EN.md)
- [zip](https://github.com/dolphindb/DolphinDBPlugin/blob/release200/zip/README_EN.md)
- [zlib](https://github.com/dolphindb/DolphinDBPlugin/blob/release200/zlib/README_ENG.md)
