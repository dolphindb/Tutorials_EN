...
In "config" directory of each server, create the configuration file of the agent (**agent.cfg**). We give an example of **agent.cfg** on each of **P1**, **P2**, **P3** and **P5**. Only **LocalSite** and **controllerSite** are mandatory configuration parameters in **agent.cfg**. All others are optional.
