...
- [Python API for DolphinDB](#python-api-for-dolphindb)
  - [1 Execute DolphinDB Scripts and Functions](#1-execute-dolphindb-scripts-and-functions)
    ...
    - [1.3 Execute DolphinDB Functions](#13-execute-dolphindb-functions)
      - [1.3.1 Parameter Passing](#131-parameter-passing)
      - [1.3.2 Data Types and Forms of Parameters](#132-data-types-and-forms-of-parameters)
    - [1.4 `undef`](#14-undef)
  ...
  - [3 Create DolphinDB Databases and Tables](#3-create-dolphindb-databases-and-tables)
    - [3.1 DolphinDB Python API Methods](#31-dolphindb-python-api-methods)
      - [3.1.1 Create OLAP Databases](#311-create-olap-databases)
      - [3.1.2 Create TSDB Databases](#312-create-tsdb-databases)
    - [3.2 `run`](#32-run)
  - [4 Import Data to DolphinDB Databases](#4-import-data-to-dolphindb-databases)
    ...
    - [4.2 Import Data as DFS Partitioned Table](#42-import-data-as-dfs-partitioned-table)
      - [4.2.1 Create a DFS Database](#421-create-a-dfs-database)
      - [4.2.2 `loadTextEx`](#422-loadtextex)
      - [4.2.3 `PartitionedTableAppender`](#423-partitionedtableappender)
    - [4.3 Import Data as Partitioned In-Memory Table](#43-import-data-as-partitioned-in-memory-table)
      - [4.3.1 `loadTextEx`](#431-loadtextex)
      - [4.3.2 `ploadText`](#432-ploadtext)
  - [5 Load Data from DolphinDB](#5-load-data-from-dolphindb)
    ...
    - [5.4 Data Conversion](#54-data-conversion)
      - [5.4.1 Data Form Conversion](#541-data-form-conversion)
  ...
  - [8 Database and Table Operations](#8-database-and-table-operations)
    ...
    - [8.2 Database Operations](#82-database-operations)
      - [8.2.1 Create Databases](#821-create-databases)
      - [8.2.2 Delete Databases](#822-delete-databases)
      - [8.2.3 Delete Database Partitions](#823-delete-database-partitions)
    - [8.3 Table Operations](#83-table-operations)
      - [8.3.1 Load Table from Database](#831-load-table-from-database)
      - [8.3.2 Append to Tables](#832-append-to-tables)
      - [8.3.3 Update Tables](#833-update-tables)
      - [8.3.4 Delete Records](#834-delete-records)
      - [8.3.5 Delete Columns](#835-delete-columns)
      - [8.3.6 Delete Tables](#836-delete-tables)
  - [9 SQL Queries](#9-sql-queries)
    - [9.1 `select`](#91-select)
      - [9.1.1 List of Column Names as Input](#911-list-of-column-names-as-input)
      - [9.1.2 String as Input](#912-string-as-input)
    - [9.2 `exec`](#92-exec)
    - [9.3 `top` & `limit`](#93-top--limit)
    - [9.4 `where`](#94-where)
      - [9.4.1 Multiple `where` Conditions](#941-multiple-where-conditions)
      - [9.4.2 String as Input](#942-string-as-input)
    - [9.5 `groupby`](#95-groupby)
    - [9.6 `contextby`](#96-contextby)
    - [9.7 `pivotby`](#97-pivotby)
    - [9.8 Table Join](#98-table-join)
      - [9.8.1 `merge`](#981-merge)
      - [9.8.2 `merge_asof`](#982-merge_asof)
      - [9.8.3 `merge_window`](#983-merge_window)
  ...
  - [10 Python Streaming API](#10-python-streaming-api)
    ...
    - [10.2 Subscribe and Unsubscribe](#102-subscribe-and-unsubscribe)
      - [10.2.1 `subscribe`](#1021-subscribe)
      - [10.2.2 Get Subscription Topics](#1022-get-subscription-topics)
      - [10.2.3 `unsubscribe`](#1023-unsubscribe)
      - [10.2.4 Streaming Subscription Cases](#1024-streaming-subscription-cases)
    - [10.3 Streaming Applications](#103-streaming-applications)
      - [10.3.1 Receive Real-Time Data and Write to DolphinDB Stream Table](#1031-receive-real-time-data-and-write-to-dolphindb-stream-table)
      - [10.3.2 Calculate OHLC Bars in Real-Time](#1032-calculate-ohlc-bars-in-real-time)
      - [10.3.3 Display OHLC Bars in Python](#1033-display-ohlc-bars-in-python)
